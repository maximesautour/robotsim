...
public class WorkArea extends CompositeComponent implements Serializable {
	
	public static final long serialVersionUID = 202605071940L;

    public WorkArea(String name, Position position, Dimension dimension) {
    ...
    public String toString() {
        return "[WorkArea] " + super.toString();
    }
}